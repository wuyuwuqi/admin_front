  ...
  <div class="order-page">
    ...
    >
      <div v-loading="orderDetailLoading" class="order-detail-dialog">
        <div v-if="!orderDetailLoading && orderDetail.id">
          <!-- 订单基本信息 -->
          <el-card class="detail-card">
            <template #header>
              <div class="card-header">
                <span>订单信息</span>
                <el-tag :type="getStatusType(orderDetail.status)">{{ statusMap[orderDetail.status] || orderDetail.status }}</el-tag>
              </div>
            </template>
            <div class="info-grid">
              <div class="info-item">
              ...
              <div class="info-item">
                ...
                <span class="info-value">{{ orderDetail.status === 'unpaid' ? '待支付' : '已支付' }}</span>
              </div>
              <div class="info-item">
          ...
          <el-card class="detail-card">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <span class="info-value">{{ orderDetail.accommodationAddress }}</span>
              </div>
              <div class="info-item">
              ...
              <div class="info-item">
                ...
                <span class="info-value">{{ orderDetail.checkDays }}天</span>
              </div>
            </div>
          </el-card>
          ...
          <el-card class="detail-card">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <span class="info-value">{{ orderDetail.checkInfo?.checkRequirements || '无特殊要求' }}</span>
              </div>
            </div>
          </el-card>
          ...
          <el-card class="detail-card">
            ...
            <el-table :data="orderDetail.guestsStaying || []" style="width: 100%" border>
        ...
        <div v-else-if="!orderDetailLoading && !orderDetail.id" class="no-data">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button 
            ...
            @click="confirmOrder(orderDetail.orderId)"
          >确认订单</el-button>
        </span>
      </template>
    </el-dialog>
...
const viewOrderDetail = async (orderId) => {
  ...
  try {
    ...
    if (response.data) {
      ...
      console.log('订单详情数据获取成功:', orderDetail.value)
    } else {
      ElMessage.warning('未找到订单详情数据')
    }
  } catch (error) {
