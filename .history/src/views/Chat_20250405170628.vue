            ...
            <template v-else>
              ...
              >
                <div class="message-avatar" v-if="!message.isSelf">
                  <el-avatar :size="36" :src="currentContact.avatar">
                    {{ currentContact.name.charAt(0) }}
                  </el-avatar>
                </div>
                <div class="message-content" :class="{ 'self-content': message.isSelf }">
                  <div class="message-bubble">
                    {{ message.content }}
                  </div>
                  <div class="message-time">{{ message.time }}</div>
                </div>
                <div class="message-avatar self-avatar" v-if="message.isSelf">
