  ...
  <div class="admin-layout">
    ...
    <div class="sidebar" :class="{ 'is-collapsed': isCollapse }">
      ...
      >
        ...
        <el-sub-menu index="/order" @click="navigateToOrder">
          <template #title>
          ...
          <el-menu-item index="/order/confirmed">
            <el-tooltip content="已确认订单" placement="right" :show-after="300">
              <span>订单详情-已确认</span>
            </el-tooltip>
          </el-menu-item>
          <el-menu-item index="/order/checked-in">
            <el-tooltip content="已入住订单" placement="right" :show-after="300">
              <span>订单详情-已入住</span>
            </el-tooltip>
          </el-menu-item>
          <el-menu-item index="/order/refunding">
            <el-tooltip content="退款中订单" placement="right" :show-after="300">
              <span>订单详情-退款中</span>
            </el-tooltip>
          </el-menu-item>
          <el-menu-item index="/order/reviewed">
            <el-tooltip content="已评价订单" placement="right" :show-after="300">
              <span>订单详情-已评价</span>
            </el-tooltip>
          </el-menu-item>
